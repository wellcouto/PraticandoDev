...
<body>
    <div class='containerPage'>
        ...
        <form id="formulario" class='form'>
            ...
            <div class='containerInput'>
                <input name="nome" id="nome" type="text" class='input' placeholder='Digite seu nome' value="<?= $rowtabela['nome'] ?>" />
            </div>
            <div class='containerInput'>
                <input name="telefone" id="telefone" type="text" class='input' placeholder='Digite seu telefone' value="<?= $rowtabela['telefone'] ?>" />
            </div>
            <div class='containerInput'>
                <input name="idade" id="idade" type="text" class='input' placeholder='Digite sua idade' value="<?= $rowtabela['idade'] ?>" />
            </div>
            ...
            <option value="<?= $rowtabela['sexo'] ?>"><?= $rowtabela['sexo'] ?></option>
                ...
                <div class='containerInput'>
                    <input id="endereco" name="endereco" type="text" class='input' placeholder='Endereço' value="<?= $rowtabela['endereco'] ?>" />
                </div>
            <div class='containerInput'>
                <input id="senha" name="senha" type="password" class='input' placeholder='Digite sua senha' value="<?= $rowtabela['senha'] ?>" />
            </div>
            <div class='buttons'>
                <button type="submit" class="button">Confirmar →</button>
                <a class="button" href="../../view/home/home_admin.php">Voltar ←</a>
            </div>
        </form>
...
<script>
		jQuery('#formulario').submit(function () {
			...
			jQuery.ajax({
				type: "POST",
				url: "../../controller/atualizar/atualizar_usuario_pelo_admin.php",
				data: dados,
