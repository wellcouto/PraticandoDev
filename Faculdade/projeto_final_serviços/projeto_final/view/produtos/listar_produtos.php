            ...
            <div class='itens'>
                ...
                if ($sql->rowCount() > 0) {
                    foreach ($rowtabela as $row) {
                        ...
                        <div class='buttons'>
                            <a class='delete' href='deletar_produto.php?id=" . $row["id"] . "' ><i class='fas fa-trash'>Deletar</i></a>
                            <a class='edit' href='editar_produtos.php?id=" . $row["id"] . "' ><i class='fas fa-edit'>Editar</i></a>
